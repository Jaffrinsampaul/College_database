...
#     print("-------------------------------------")
#     print("Standard Deviation of marks data is % s " % (
#         statistics.stdev(std_dev_data)))  # Library function to compute S.D
#     print("-------------------------------------")
#
#
...
#
#     else:
#         print("Invalid Choice, Try again!", {record})
...
#     data.append(mobile)
#     data.append(mark)
#     print(f"Data variable value : {data}")
#     record.append(data)
#     print(f"Record variable value : {record}")
#
# create_student()


# name = ["Jaffrin", "sampaul", "joe"]
# with open("fie.txt", "w") as file:
#     for row in name:
#         s = " ".join(map(str, row))
#         file.write(s + '\n')
#
...
#
# text_file = open("fie.txt", "r")
#
# for x in text_file:
#     pdf.cell(200, 10, txt= x, ln = 1, align= "C")
# pdf.output("Poda.pdf")

colors = [11, 34.1, 98.2, 43, 45.1, 54, 54,"jaffrin"]
...
#         print(x)
    # if isinstance(x, int):
    #     print(x)
# mynew = [s for s in colors if s.isdigit()]
# print(mynew)
# new = []
# str1 = []
# for value in colors:
